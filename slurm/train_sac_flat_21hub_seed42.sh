#!/bin/bash
#SBATCH --job-name=flat_21hub_s42
#SBATCH --account=fr57
...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_flat_21hub_s42.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_flat_21hub_s42.err
...
python train_sac_gnn.py \
    ...
    --episodes 1500 \
    --seed 42 \
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/sac_flat_21hub_seed42_20260904
