#!/bin/bash
#SBATCH --job-name=gnn_32h_s42_ext
#SBATCH --account=fr57
...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_gnn_32h_s42_ext.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_gnn_32h_s42_ext.err
...
python train_sac_gnn.py \
    ...
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/sac_gnn_32hub_seed42_20260904_extended2500
