#!/bin/bash
#SBATCH --job-name=extended_seed1_best
#SBATCH --account=fr57
...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_extended_seed1_best.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_extended_seed1_best.err
...
# Extended-training follow-up evaluation (pre-collapse best checkpoint, ~ep1950).
# SAC-GNN checkpoint is the best.pt from the resumed
...
python evaluate.py \
    ...
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/evaluation_32hub_seed1_extended2500_best_20260904
