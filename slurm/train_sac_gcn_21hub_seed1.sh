...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_gcn_21hub_s1.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_gcn_21hub_s1.err
...
python train_sac_gnn.py \
    ...
    --episodes 1500 \
    --seed 1 \
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/sac_gcn_21hub_seed1_20260904
