...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_eval_seed1.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_eval_seed1.err
...
python evaluate.py \
    ...
    --n_runs 30 \
    --seed 1 \
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/evaluation_seed1
