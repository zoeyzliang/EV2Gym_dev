#!/bin/bash
#SBATCH --job-name=sac_gnn_seed42
#SBATCH --account=fr57
...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_sac_gnn_seed42.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_sac_gnn_seed42.err
...
# Sync to latest committed code before training (matches past job logs)
...
python train_sac_gnn.py \
    ...
    --episodes 1500 \
    --seed 42 \
    --results_dir /scratch2/fr57/zlia0072/ev2gym_training/results/sac_gnn_real_seed42
