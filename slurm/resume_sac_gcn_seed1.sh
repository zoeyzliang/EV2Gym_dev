#!/bin/bash
#SBATCH --job-name=sac_gcn_resume_seed1
#SBATCH --account=fr57
...
#SBATCH --output=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_sac_gcn_resume_seed1.out
#SBATCH --error=/scratch2/fr57/zlia0072/ev2gym_training/logs/slurm_%j_sac_gcn_resume_seed1.err
